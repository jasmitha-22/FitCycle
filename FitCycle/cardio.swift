        ...
        ZStack{
            ...
            VStack{
                Text("Level: Gentle")
                    ...
                    .cornerRadius(15)
                WebView(urlString: "https://www.youtube.com/embed/WjH-NQDeQ3o?si=jw4zqmFH50Xge0-G")
                ...
                Text("Level: Intermediate")
                    ...
                    .background(Rectangle()
                        .foregroundColor(Color(red: 0.9490196078431372, green: 0.7607843137254902, blue: 0.8352941176470589)))
                    .cornerRadius(15)
                WebView(urlString: "https://www.youtube.com/embed/v3SGmJPDNVw?si=TLwCDlC-BvPkd1XU")
                ...
                Text("Level: Advanced")
                    ...
                    .background(Rectangle()
                        .foregroundColor(Color(red: 0.9490196078431372, green: 0.7607843137254902, blue: 0.8352941176470589)))
                    .cornerRadius(15)
                WebView(urlString: "https://www.youtube.com/embed/kZDvg92tTMc?si=SqkFR_ptbf1rG1_I")
                    .frame(width:350, height:180)
