        ...
        ZStack{
            ...
            VStack{
                Text("Level: Gentle")
                    ...
                    .cornerRadius(15)
                WebView(urlString: "https://www.youtube.com/embed/VCueQdbl1t0?si=1b2kF3yQGkNjAGX9")
                ...
                Text("Level: Intermediate")
                    ...
                    .background(Rectangle()
                        .foregroundColor(Color(red: 0.9490196078431372, green: 0.7607843137254902, blue: 0.8352941176470589)))
                    .cornerRadius(15)
                WebView(urlString: "https://www.youtube.com/embed/ZaaCFwO2XXQ?si=ylqPAYLsnuiCBMd8")
                ...
                Text("Level: Advanced")
                    ...
                    .background(Rectangle()
                        .foregroundColor(Color(red: 0.9490196078431372, green: 0.7607843137254902, blue: 0.8352941176470589)))
                    .cornerRadius(15)
                WebView(urlString: "https://www.youtube.com/embed/Ocx_Xd1e_BU?si=l0ub50DTF4ti0NJj")
                    .frame(width:350, height:180)
