        ...
        ZStack{
            ...
            VStack{
                Text("Level: Gentle")
                    ...
                    .cornerRadius(15)
                WebView(urlString: "https://www.youtube.com/embed/4Ixz9eJpq_A?si=qLclLJ8mXPeXq7Cq")
                ...
                Text("Level: Intermediate")
                    ...
                    .background(Rectangle()
                        .foregroundColor(Color(red: 0.9490196078431372, green: 0.7607843137254902, blue: 0.8352941176470589)))
                    .cornerRadius(15)
                WebView(urlString: "https://www.youtube.com/embed/ZbtVVYBLCug?si=faX8H5WOhj3NXPv8")
                ...
                Text("Level: Advanced")
                    ...
                    .background(Rectangle()
                        .foregroundColor(Color(red: 0.9490196078431372, green: 0.7607843137254902, blue: 0.8352941176470589)))
                    .cornerRadius(15)
                WebView(urlString: "https://www.youtube.com/embed/sJzuvjzRqDQ?si=Sw8C8PfwHkXMt7RH")
                    .frame(width:350, height:180)
