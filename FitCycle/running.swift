        ...
        ZStack{
            ...
            VStack{
                Text("Level: Gentle")
                    ...
                    .cornerRadius(15)
                WebView(urlString: "https://www.youtube.com/embed/BrliNdYmRVQ?si=Xj0WaCem5XaSpVzV")
                ...
                Text("Level: Intermediate")
                    ...
                    .background(Rectangle()
                        .foregroundColor(Color(red: 0.9490196078431372, green: 0.7607843137254902, blue: 0.8352941176470589)))
                    .cornerRadius(15)
                WebView(urlString: "https://www.youtube.com/embed/M841zNhi68w?si=Ps1YpYne-nnso3Ts")
                ...
                Text("Level: Advanced")
                    ...
                    .background(Rectangle()
                        .foregroundColor(Color(red: 0.9490196078431372, green: 0.7607843137254902, blue: 0.8352941176470589)))
                    .cornerRadius(15)
                WebView(urlString: "https://www.youtube.com/embed/Ggub5uUtG-U?si=ICdnbPAIZvaF3fLR")
                    .frame(width:350, height:180)
